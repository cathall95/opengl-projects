...
osg::Geode* createPyramid()
{
   ...
   colors->push_back(osg::Vec4(0.0f, 0.0f, 0.6f, 1.0f) ); //index 0 purple
   colors->push_back(osg::Vec4(1.0f, 1.0f, 0.0f, 1.0f) ); //index 1 yellow
   colors->push_back(osg::Vec4(0.0f, 1.0f, 1.0f, 1.0f) ); //index 2 cyan
   colors->push_back(osg::Vec4(1.0f, 0.49f, 0.0f, 1.0f) ); //index 3 orange
   colors->push_back(osg::Vec4(1.0f, 0.0f, 1.0f, 1.0f) ); //index 3 pink
   ...
   (*texcoords)[2].set(0.33f,0.0f); // tex coord for vertex 2
...
int main()
{
   ...
   osg::Image* klnFace = osgDB::readImageFile("cs4815/labs/week11/KLN89FaceB.tga");
